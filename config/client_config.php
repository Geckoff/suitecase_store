<?php
	$upDomainName = "http://test.1bags.by";
    ...
    $ClientConfig = array(
        ...
        'top_block' => '4',
        'contacts_block' => '5',
        'count_per_page' => '18',	// Количество элементов на странице ( Пока что во всех модулях )
        'orderby' => 'default',
        
        'og-title' => 'Супер распрдажа в интернет-магазине 1bags.by!',
        'og-description' => 'Скидки до 50%, подарок с каждой покупкой, бесплатная доставка! 1bags.by - это чемоданы, рюкзаки, дорожные сумки, мужские сумки, кошельки и много другое по очень доступным ценам! ',
        'og-image' => ''
    );
