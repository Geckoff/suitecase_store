<?php
    $DO = array(
        ...
        'show' => array(array('id' => 'INT', 'slider' => 'INT'), array(), 'controller_show.php'),
        'delete' => array(array('id' => 'INT'), array(), 'controller_delete.php'),
        'save' => array(array(), array('id' => 'INT', 'parent' => 'INT', 'title' => 'STRING', 'description' => 'STRING', 'url' => 'STRING_ADDSL'), 'controller_save.php'),
