...
$DO = array(
	...
	'item_append_save' => array(array('into' => 'INT'), array('description' => 'STRING', 'seo' => 'STRING','images' => 'STRING_ADDSL', 'params' => 'STRING'), 'controller_item_save.php'),
	'item_edit' => array(array('id' => 'INT'), array(), 'controller_item_edit.php'),
	'item_edit_save' => array(array('id' => 'INT'), array('description' => 'STRING', 'seo' => 'STRING','images' => 'STRING_ADDSL', 'params' => 'STRING'), 'controller_item_save.php'),
	// special tree actions
	'parameters_show' => array(array('id' => 'INT'), array(), 'controller_tree_parameters_show.php'),
	'parameters_save' => array(array('id' => 'INT'), array('groups' => 'STRING'), 'controller_tree_parameters_save.php'),
);
?>
