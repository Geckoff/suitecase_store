		...
		<div class="block">
			<table cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<td>
						<textarea name="description[description]" <?php if($Config['common']['editor'] == true) echo 'id="tmce1" cols="80" rows="20"'; else echo 'rows="5"'; ?>><?php if (isset($TREE['description'])) echo htmlspecialchars($TREE['description']); ?></textarea> 
					</td>
				</tr>
				<tr>
