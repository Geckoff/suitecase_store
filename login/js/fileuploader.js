...
qq.FileUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            ...
            sizeError: "{file} является слишком большим. Максимальный размер файла {sizeLimit}.",
            minSizeError: "{file} является слишком маленьким. Минимальный размер файла {minSizeLimit}.",
            emptyError: "{file} пуст. Выбирите файл еще раз.",
            noFilesError: "Нет файлов для загрузки.",
            onLeave: "Файлы загружаются, если вы оставите их сейчас, то загрузка будет отменена."
        },
